<template>
    <Header></Header>
  <div class="total_wrapper" style="margin-top: 50px">
  <a :href="route('home')" style="font-weight: 500; font-size: 12px; color: #878787"
      ...
      ><a :href="route('photoalbum')" style="font-weight: 500; font-size: 12px; color: #878787"
        >Фото > </a
      >
      <a :href="route('photoofalbumview', photocollection.id)" style="font-weight: 500; font-size: 12px; color: #878787"
      >{{ photocollection.name }} > </a
      >
      <a style="font-weight: 500; font-size: 12px; color: #ffffff" href="#"
        >{{ photo.name }}</a
      >
    <div class="wrapper__foto" style="margin-top: 30px;">
      <div class="wraperr__foto__img">
        <img style="max-height: 650px; object-fit: contain;" :src="(help + photo.photo)" :alt="photo.name" />
        <p style="margin-top: 10px; text-align: left">{{photo.name}}</p>
         <article>{{photo.loc_photo}}  </article>
      </div>
      <div class="wraperr__foto__btns">
         <a href="#ModalBuyPhoto" class="foto__btn__pay" style="display: block;">
          <p>Приобрести</p>
        </a>
        <!-- <div class="foto__btn__favourites" style="visibility: hidden">
          <p>В избранное</p>
    ...
    <div class="wrapper__avtor" v-if="photo.author_name">
      <p>Автор: <a :href="route('actor', photo.author_hoto_id)"><span v-html="photo.author_name + ' ' + photo.author_last_name"></span></a>
    ...
    <div class="wrapper__other_foto">
      ...
      <div class="wrapper__carusel wrapper__carusel__collection wrapper__carusel__category">
          <div class="carusel__line carusel_line_collection carusel_line_category">
              <div v-for="photoss in photos">
                  <a :href="route('photo', photoss.id)"><div class="carusel__block">
                      <img style="object-fit: cover" :src="(help + photoss.photo)" :alt="photoss.name" />
                  </div></a>
              </div>
          </div>
      </div>
...
export default {
  ...
  components: {
    ...
    methods: {
      ...
      formData.append('photo', this.photo.id);
      // console.log(this.name);
      // console.log(this.numder);
      // console.log(this.email);
      e.preventDefault();
        let url = '/orderes/photo';
