        ...
        <div class="wrapper_actor_info">
            <div class="actor_info__img">
                <div class="actor_info__img__block">
                    <img :src="(help + studia.photo)" :alt="studia.name" />
                </div>
            </div>
            <div class="actor_info__text">
                <h2>{{studia.name}} </h2>
                <h3>О cтудии</h3>
                <p>Фильмография:<span class="studia-text" v-html="studia.prew"></span></p>
                <h4>История: </h4>
                <span class="studia-text" v-html="studia.history"></span>
