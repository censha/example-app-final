  ...
  <main class="polit main">
    <div class="item">
      ...
      <section class="section2__section2">
        <h1 class="section2__hero_title">Форма согласия владельца собственности</h1>
        ...
        <div class="section3__row">
          ...
          <div class="item1">
            <div class="section3__col1">
              <h3 class="section3__subtitle2">Форма согласия владельца собственности</h3>
              <h5 class="section3__highlights4">
                В данном раздели будут расположены документы и информация, о форме согласия владельца собственности.
                В данном раздели будут расположены документы и информация, о форме согласия владельца собственности.
                В данном раздели будут расположены документы и информация, о форме согласия владельца собственности.
                В данном раздели будут расположены документы и информация, о форме согласия владельца собственности.
                В данном раздели будут расположены документы и информация, о форме согласия владельца собственности.
